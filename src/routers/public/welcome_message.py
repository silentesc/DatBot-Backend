...
async def get_welcome_message(session_id: str, guild_id: str) -> WelcomeMessage | None:
...
async def set_welcome_message(session_id: str, guild_id: str, channel_id: str, message: str) -> None:
...
async def delete_welcome_message(session_id: str, guild_id: str) -> None:
