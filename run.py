...
def run_public_app():
    uvicorn.run("src.public_app:app", host="0.0.0.0", port=8000, reload=False, workers=4)

def run_internal_app():
    uvicorn.run("src.internal_app:app", host="0.0.0.0", port=9000, reload=False, workers=4)
